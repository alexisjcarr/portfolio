  ...
  <div>
    ...
    <div className="designs-container">
      <div className="designs-card">
        ...
        <p>Soon, I will start compiling systems designs and solutions architectures that I come up with in my free time. I am currently working on the following designs. When one is in progress, I will add a <span id="icon">⏳</span> next to the link. When one is ready, I will add a <span id="icon">✅</span> next to it. STAY TUNED!</p>
        <br />
        <a href="">
          <p><span id="icon">⏳</span> Code Deployment System</p>
        </a>
        <a href="">
          <p>Stockbroker App</p>
        </a>
