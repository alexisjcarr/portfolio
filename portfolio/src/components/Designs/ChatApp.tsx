    ...
    <div className="designs-container">
      <div className="designs-card">
        ...
        <p><h2>I. Understanding the Goals</h2></p>
            <p>
               The goal of this post is to design a chat application that can be used by an online multiplayer game that my friend is building. Although, the following design is for scale, I mostly designed this for the mental challenge, and we will build this on a much smaller (and less distributed) scale. For the purposes of this post, pretend that we have a cool $100 mil burning a hole in our collective pockets, and I was charged with designing the infra for a massively popular game that'll be hot only in the US.
            </p>
            <p>
