    ...
    <div className="designs-container">
      <div className="designs-card">
        ...
        <p><h2>I. Understanding the Goals</h2></p>
            ...
            <p>
                The chat system have similar inputs to that of the game— authenticated user GUIDs, user aliases, and session id. Said session id will be generated by the system when the user creates a new chat.
            </p>
            <p>
