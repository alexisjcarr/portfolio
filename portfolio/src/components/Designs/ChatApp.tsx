    ...
    <div className="designs-container">
      <div className="designs-card">
        ...
        <p><h2>I. Understanding the Goals</h2></p>
            ...
            <p>
                The chat system have similar inputs to that of the game— authenticated user GUIDs, user aliases, and session ids. Said session id will be generated by the system when the user initiates a new chat.
            </p>
            <p>
        ...
        <p><h2>II. Scope</h2></p>
            ...
            <p>
                Although, analytics, logging, and monitoring are not explained in detail this design, we would likely both 1) implement Google Analytics to get frontend metrics and 2) use the ELK stack or Splunk for log management and a tool such as DataDog or AWS CloudWatch for monitoring and metrics. 
            </p>
            <br />
        <p><h2>III. Scale</h2></p>
            <p>
        ...
        <p><h3>Database</h3></p>
            ...
            <p>
                One problem I wanted to be mindful of should we go with a self-managed database solution (to save money) is how we'll handle both scaling reads and making our database solution fault-tolerant and highly available. In this regard, having a leader-replica configuration should work. For a single region deployment, one leader with two replicas in different availability zones is more than sufficient. We could even add in ProxySQL to handle delegating all writes to the leader and reads to the replicas, but adding that in the service configs/logic would be a smaller lift.
            </p>
            <p>
                For managing failover, I would use a key-value store like Zookeeper or etcd to manage leader election. 
            </p>
        <br />
